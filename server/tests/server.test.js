...
describe('PATCH /todos/:id', () => {
    it('should update todo', (done) => {
        ...
        request(app)
            ...
            .expect(200)
            .expect((res) => {
                expect(res.body.todo.text).toBe('updated string');
    ...
    it('should clear completedAt when Todo is not completed', (done) => {
        ...
        request(app)
            ...
            .expect(200)
            .expect((res) => {
                expect(res.body.todo.text).toBe('second todo is now updated');
